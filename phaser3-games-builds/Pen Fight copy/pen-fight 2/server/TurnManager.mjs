...
export default class TurnManager {
  ...
  // startIndex — which player goes first (see GameRoom.mjs's
  // matchesPlayed / round-robin rotation). Defaults to 0 for anything
  // that doesn't care (e.g. reset()'s implicit "next match" fallback).
  start(startIndex = 0) {
    this.started = true;
