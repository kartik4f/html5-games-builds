...
//
// This isn't an npm project — there's no package.json and nothing to
// `npm install`. The .mjs extension is what tells Node "treat this as
// an ES module" without needing one. Just `node server.mjs`.
//
