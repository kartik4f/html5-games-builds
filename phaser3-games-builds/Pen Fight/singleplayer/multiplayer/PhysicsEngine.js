//==================================================
// PhysicsEngine.js  (server-side, zero-dependency)
//==================================================
// The single-player client simulates pens with Planck (a real Box2D
// port) loaded from a CDN. That's fine for a client, but a server has
// no browser and this sandbox has no npm registry access to install
// Planck (or anything else) for Node either — so instead of depending
// on a physics engine, this is a small self-contained rigid-body sim
// written specifically for this game: two capsule-shaped pens sliding
// around a table, bouncing off the rails and off each other.
//
